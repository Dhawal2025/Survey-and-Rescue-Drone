...
class Edrone():
	...
	def __init__(self):
		...
		self.setpoint = [-4.5,-5.5,20]
		self.waypoints = [[-4.5,-5.5,20],[-11,-5,20]]
		self.level=0
		...
		# self.Kp = [920*0.02, 800*0.02,1600*0.06]
		# self.Ki = [0.1,0.2, 0.2]
		# self.Kd = [2400*0.3, 1800*0.3,1500*0.3]
	...
	#	8. Add error_sum
		...
		elif((self.drone_position[0]>=self.waypoints[self.level][0]-0.5 and self.drone_position[0]<=self.waypoints[self.level][0]+0.5) and (self.drone_position[1]>=self.waypoints[self.level][1]-0.5 and self.drone_position[1]<=self.waypoints[self.level][1]+0.5) and (self.drone_position[2]>=self.waypoints[self.level][2]-1.0 and self.drone_position[2]<=self.waypoints[self.level][2]+1.0) ):
