...
class Edrone():
	...
	def __init__(self):
		...
		# [x,y,z]
		self.drone_position = [0.0, 0.0, 35.0]
		...
		self.Kp = [0, 0,1300*0.06]
		self.Ki = [0, 0, 0]
		self.Kd = [0, 0,3500*0.3]
	...
	#	8. Add error_sum
		...
		self.out_roll = self.Kp[0]*self.error[0]+self.iterm[0]+self.Kd[0]*(self.error[0]-self.prev_err[0])
		self.out_pitch = self.Kp[1]*self.error[1]+self.iterm[1]+self.Kd[1]*(self.error[1]-self.prev_err[1])
