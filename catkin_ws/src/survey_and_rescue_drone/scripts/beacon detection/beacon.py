...
class sr_determine_colors():
	...
	def __init__(self):
		...
		self.state={"A2":"","B3":"","C1":"","F2":"","D4":"","F6":"","C5":"","B6":""}
 		self.boundaries = [
		("RESCUE",[10, 10, 130], [90, 80, 255]),
		("MEDICINE",[86, 5, 4], [230, 88, 60]),
		("FOOD",[10, 105, 10], [90,255 , 70])]
		# self.boundaries = [
	...
	def load_rois(self, file_path = 'rect_info.pkl'):
		try:
			...
			with open("/home/dhawal/catkin_ws/roi.json", 'rb') as input:
 	...
 	def image_callback(self, data):
 		try:
			...
			self.crop_img = self.img[110:980,200:1020]
